...
//    }
//    @GetMapping("/page/{sahifa}/{soni}")
//    public HttpEntity<?> sahifalash(@PathVariable Integer sahifa,@PathVariable Integer soni){
//        return ResponseEntity.status(HttpStatus.OK).body(manzilService.sahifalash(sahifa,soni));
//    }
////    public HttpEntity<?> sahifalash(@RequestParam(defaultValue = "2") Integer sahifa,@RequestParam(defaultValue="5") int soni){
////        return ResponseEntity.status(HttpStatus.OK).body(manzilService.sahifalash(sahifa,soni));
////    }
//}
